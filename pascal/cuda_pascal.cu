...
#define ch(a, b, c) ((c & b) | (a & (c | b)))
//#define ch(a, b, c) (((a & b) ^ (a & c) ^ (b & c)))

#define round(a, b, c, d, e, f, g, h, i)\
			t1 = h + rot1(e) + maj(e, f, g) + k[i] + w[i]; \
			h = rot2(a) + ch(a, b, c) + t1; \
			d += t1;

#define round_no_w(a, b, c, d, e, f, g, h, i)\
			t1 = h + rot1(e) + maj(e, f, g) + k[i]; \
			h = rot2(a) + ch(a, b, c) + t1; \
			d += t1;
...
#pragma unroll
			...
			t1 = rot1(d) + (0x9b05688cU ^ (d & 0xca0b3af3)) + 0x90bb1e3cU + w[1];
			c = 0x3c6ef372U + t1;
			g = t1 + rot2(h) + (0x2A01A605 | (h & 0xfb6feee7));
			
			t1 = rot1(c) + (0x510e527fU ^ (c & (d ^ 0x510e527fU))) + 0x50C6645BU + w[2];
			b = 0xbb67ae85U + t1;
			f = t1 + rot2(g) + ((0x6a09e667U & h) | (g & (0x6a09e667U | h)));
			
			t1 = rot1(b) + maj(b, c, d) + 0x3AC42E24U + w[3];
			a = 0x6a09e667U + t1;
			e = t1 + rot2(f) + ch(f, g, h);
			
			t1 = d + rot1(a) + maj(a, b, c) + 0x3956c25bU + w[4];
			h += t1;
			d = t1 + rot2(e) + ch(e, f, g);
			
			t1 = c + rot1(h) + maj(h, a, b) + 0x59f111f1U + w[5];
			g += t1;
			c = t1 + rot2(d) + ch(d, e, f);
			
			t1 = b + rot1(g) + maj(g, h, a) + 0x923f82a4U + w[6];
			f += t1;
			b = t1 + rot2(c) + ch(c, d, e);
			
			t1 = a + rot1(f) + maj(f, g, h) + 0xab1c5ed5U + w[7];
			e += t1;
			a = t1 + rot2(b) + ch(b, c, d);
			
			t1 = h + rot1(e) + maj(e, f, g) + 0x5807aa98U;
			d += t1;
			h = t1 + rot2(a) + ch(a, b, c);
			
			round_no_w(h, a, b, c, d, e, f, g, 9);
			round_no_w(g, h, a, b, c, d, e, f, 10);
			round_no_w(f, g, h, a, b, c, d, e, 11);
			round_no_w(e, f, g, h, a, b, c, d, 12);
			round_no_w(d, e, f, g, h, a, b, c, 13);
			round_no_w(c, d, e, f, g, h, a, b, 14);

			t1 = a + rot1(f) + maj(f, g, h) + 0xc19bf274U;
			a = rot2(b) + ch(b, c, d) + t1;
			e += t1;
