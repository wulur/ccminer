...
//		quark_keccak512_cpu_init(thr_id);
	...
	do {
		...
		quark_keccakskein512_cpu_hash_64(thr_id, throughput, pdata[19], NULL, d_hash[thr_id]);
		...
		cuda_check_quarkcoin(thr_id, throughput, pdata[19], NULL, d_hash[thr_id], foundnonces);
